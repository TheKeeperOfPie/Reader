 ...
 */
/*
 * Code copied from android.support.v7.widget.helper.ItemTouchHelper
 * with some sections changed to allow nesting of scrollable views and to
 * prevent dismissal from fling action
 *
 *
...
public class CustomItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    private abstract class CustomOnItemTouchListener implements RecyclerView.OnItemTouchListener {
        abstract void setDisallow(boolean disallow);
    }

    private final CustomOnItemTouchListener mOnItemTouchListener
            = new CustomOnItemTouchListener() {

        private boolean disallow;

        @Override
        void setDisallow(boolean disallow) {
...
//            return mSelected != null;
    ...
    public void setDisallow(boolean disallow) {
        mOnItemTouchListener.setDisallow(disallow);
    }
...
//            }
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         *                  {@link #UP} and {@link #DOWN}.
         */
        public SimpleCallback(Context context, int iconUnderResource, int dragDirs, int swipeDirs) {
            mDefaultSwipeDirs = swipeDirs;
            mDefaultDragDirs = dragDirs;
            this.sideMargin = context.getResources()
        ...
        public void setDrawable(Context context, int drawableResource) {
            iconUnder = context.getResources().getDrawable(drawableResource);
        }
            ...
            if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                ...
                if (dX > 0) {
                    ...
                    iconUnder.setBounds(
                            ...
                            (int) ((bottom - top) / 2f + sizeIcon / 2f + top));
                    canvas.drawRect(right + dX, top, right, bottom, paintUnder);
                }
                iconUnder.draw(canvas);
