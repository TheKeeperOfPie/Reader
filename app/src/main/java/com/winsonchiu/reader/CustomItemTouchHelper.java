 ...
 */
/*
 * Code entirely copied from android.support.v7.widget.helper.ItemTouchHelper
 * with horizontal velocity section commented out, as item will accidentally dismiss
 * if flung and returned otherwise.
 *
 *
